...
const WishlistsPage = () => {
  ...
  return (
    <div className='grid grid-rows-[20px_1fr_20px] text-xl min-h-screen p-8 pb-20 gap-16 sm:p-20'>
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
          ...
          {wishlists.map((wishlist) => (
            <li key={wishlist.id} className="mb-4 w-full">
                <div className="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  <a href="#">
                    <Title text={wishlist.name} level={HeadingLevel.H3} />
                  </a>
                  <ul>
                  ...
                  <button
                    ...
                    className="focus:outline-none text-xl text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
                  >
                    Delete
                  </button>
                </div>
        ...
        <button
          ...
          className="text-white text-xl bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          Create Wishlist
        </button>
      </main>
